...
namespace PropSeekr.Migrations
{
    ...
    [Migration("20260911120704_VersionWalletLedgerAndCreditCatalogue")]
    partial class VersionWalletLedgerAndCreditCatalogue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropSeekr.Models.BulkImportJob", b =>
                {
                    ...
                    b.Property<string>("UploadETag")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("upload_etag");

                    b.Property<long?>("UploadSizeBytes")
                        .HasColumnType("bigint")
                        .HasColumnName("upload_size_bytes");

                    b.Property<DateTime?>("UploadVerifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("upload_verified_at");
                    ...
                    b.ToTable("bulk_import_jobs", null, t =>
                        {
                            t.HasCheckConstraint("CK_bulk_import_jobs_upload_size_positive", "upload_size_bytes IS NULL OR upload_size_bytes > 0");
                        });
                });
            ...
            modelBuilder.Entity("PropSeekr.Models.EmbeddingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("embedding_jobs", null, t =>
                        {
                            t.HasCheckConstraint("CK_embedding_jobs_status_valid", "status IN ('queued', 'processing', 'completed', 'failed', 'superseded')");

                            t.HasCheckConstraint("CK_embedding_jobs_target_version_positive", "target_version > 0");
                        });
                });
            ...
            modelBuilder.Entity("PropSeekr.Models.Listing", b =>
                {
                    ...
                    b.ToTable("listings", null, t =>
                        {
                            t.HasCheckConstraint("CK_listings_content_version_positive", "content_version > 0");

                            t.HasCheckConstraint("CK_listings_embedding_status_valid", "embedding_status IN ('queued', 'processing', 'completed', 'failed', 'not_required')");

                            t.HasCheckConstraint("CK_listings_embedding_version_valid", "embedding_version IS NULL OR (embedding_version > 0 AND embedding_version <= content_version)");
                        });
                });
            ...
            modelBuilder.Entity("PropSeekr.Models.PendingRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropSeekr.Models.Requirement", b =>
                {
                    ...
                    b.ToTable("requirements", null, t =>
                        {
                            t.HasCheckConstraint("CK_requirements_content_version_positive", "content_version > 0");

                            t.HasCheckConstraint("CK_requirements_embedding_status_valid", "embedding_status IN ('queued', 'processing', 'completed', 'failed', 'not_required')");

                            t.HasCheckConstraint("CK_requirements_embedding_version_valid", "embedding_version IS NULL OR (embedding_version > 0 AND embedding_version <= content_version)");
                        });
                });
            ...
            modelBuilder.Entity("PropSeekr.Models.WidgetOtpChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ConsumedTokenHash")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("ConsumedTokenHash")
                        .IsUnique();

                    b.HasIndex("MobileNumber", "CreatedAt");

                    b.ToTable("widget_otp_challenges", (string)null);
                });
